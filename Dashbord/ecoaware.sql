...
CREATE TABLE `actualite` (
  `IdActualite` int(5) NOT NULL,
  `TitreActualite` varchar(50) NOT NULL,
  `DateActualite` date NOT NULL,
  `DescriptionActualite` varchar(300) NOT NULL,
  `ImageActualite` int(30) NOT NULL
...
(5, 'f', '2021-11-15', 'v', 0),
(6465, 'fjdhfjbwdj', '2021-11-03', 'nxw,bc,wxbc,xb,bwx,vwxv<wx654<cxnbcn', 0);
...
CREATE TABLE `event` (
  `id-eve` int(5) NOT NULL,
  `nom` varchar(50) NOT NULL,
  `date` date NOT NULL,
  `prix-dt` int(11) NOT NULL,
